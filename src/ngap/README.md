...
- Step 2: extract ASN1 from  3GPP TS 38.413 (just copy the message and information element (with ASN.1) from TS 38.413 and put in e.g., ts38.413.asn1)
- Step 3: Generate NGAP source files with following commands:
