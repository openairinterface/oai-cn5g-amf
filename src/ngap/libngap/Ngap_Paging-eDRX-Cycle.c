 ...
 */
static asn_oer_constraints_t asn_OER_type_Ngap_Paging_eDRX_Cycle_constr_1
    CC_NOTUSED = {{0, 0}, -1};
asn_per_constraints_t asn_PER_type_Ngap_Paging_eDRX_Cycle_constr_1
    CC_NOTUSED = {
...
static const asn_INTEGER_enum_map_t
    asn_MAP_Ngap_Paging_eDRX_Cycle_value2enum_1[] = {
...
asn_TYPE_descriptor_t asn_DEF_Ngap_Paging_eDRX_Cycle = {
    ...
    sizeof(asn_DEF_Ngap_Paging_eDRX_Cycle_tags_1) /
        sizeof(asn_DEF_Ngap_Paging_eDRX_Cycle_tags_1[0]), /* 1 */
    {&asn_OER_type_Ngap_Paging_eDRX_Cycle_constr_1,
