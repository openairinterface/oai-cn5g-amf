...
using namespace oai::amf_server::model;

class SubscriptionsCollectionApiImpl
    : public oai::amf_server::api::SubscriptionsCollectionApi {
 public:
  SubscriptionsCollectionApiImpl(
      std::shared_ptr<Pistache::Rest::Router>, amf::amf_app* amf_app_inst,
      std::string address);
  ~SubscriptionsCollectionApiImpl() {}
