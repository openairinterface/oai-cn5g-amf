...
/* The 32x32-bit S-Box S1
 ...
 significant byte. S1(w)= r0 || r1 || r2 || r3 with r0 the most and r3 the least
 significant byte.
 */
...
/* The 32x32-bit S-Box S2
 ...
 Let w = w0 || w1 || w2 || w3 the 32-bit input with w0 the most and w3 the least
 significant byte. Let S2(w)= r0 || r1 || r2 || r3 with r0 the most and r3 the
