...
typedef enum {
  ...
  HEALTH_PING,
  TERMINATE,
  BROADCAST_SESSION_SETUP_RESPONSE,
  BROADCAST_SESSION_SETUP_FAILURE,
  BROADCAST_SESSION_MODIFICATION_RESPONSE,
  BROADCAST_SESSION_MODIFICATION_FAILURE,
  BROADCAST_SESSION_RELEASE_RESPONSE,
  BROADCAST_SESSION_RELEASE_REQUIRED,
  DISTRIBUTION_SETUP_REQUEST,
  DISTRIBUTION_RELEASE_REQUEST,
  MULTICAST_SESSION_ACTIVATION_RESPONSE,
  MULTICAST_SESSION_ACTIVATION_FAILURE,
  MULTICAST_SESSION_DEACTIVATION_RESPONSE,
  MULTICAST_SESSION_UPDATE_RESPONSE,
  MULTICAST_SESSION_UPDATE_FAILURE,
  ITTI_MSG_TYPE_MAX
} itti_msg_type_t;
