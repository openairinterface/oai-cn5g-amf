  ...
  const char* get_msg_name() {
    switch (msg_type) {
      ...
      case NUDSF_STORE_UE_CONTEXT_REQUEST:
        return "NUDSF_STORE_UE_CONTEXT_REQUEST";
      case NUDSF_STORE_UE_CONTEXT_RESPONSE:
        return "NUDSF_STORE_UE_CONTEXT_RESPONSE";
      case NUDSF_GET_UE_CONTEXT_REQUEST:
        return "NUDSF_GET_UE_CONTEXT_REQUEST";
      case NUDSF_GET_UE_CONTEXT_RESPONSE:
        return "NUDSF_GET_UE_CONTEXT_RESPONSE";
      case NUDSF_DELETE_UE_CONTEXT_REQUEST:
        return "NUDSF_DELETE_UE_CONTEXT_REQUEST";
      case NUDSF_DELETE_UE_CONTEXT_RESPONSE:
        return "NUDSF_DELETE_UE_CONTEXT_RESPONSE";
